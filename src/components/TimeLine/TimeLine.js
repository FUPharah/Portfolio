...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <br />
      I am a hardworking and passionate web developer with strong organizational skills and attention to detail. With over 1000 hours of coding experience and expertise in programming languages such as Ruby, JavaScript, and HTML & CSS, I am confident in my ability to deliver professional results and contribute to the success of any web development project.
